...
const programming = `${cardData.labelProgramming}  ${cardData.programming}`
const languageing = `${cardData.labelLanguages}  ${cardData.languages}`

// Put all our output together into a single variable so we can use boxen effectively
const output = heading + // cardData.name + cardData.handle
